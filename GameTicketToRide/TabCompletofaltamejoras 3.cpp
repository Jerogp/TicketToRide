...
void imprimirTablero() {
    ...
    tablero[12][15].color = BG_RED; // (13,16)
    tablero[13][15].color = BG_RED; // (14,16)
    tablero[13][14].color = BG_RED; // (14,15)
    tablero[13][13].color = BG_RED; // (14,14)

    // Punto M (14,13)
    tablero[13][12].letra = 'M';

    // Punto QS (10,19) - Verde
    tablero[9][18].letra = 'S';
    tablero[10][18].color = BG_GREEN; // (11,19)
    tablero[11][18].color = BG_GREEN; // (12,19)
    tablero[11][17].color = BG_GREEN; // (12,18)
    tablero[11][16].color = BG_GREEN; // (12,17)
